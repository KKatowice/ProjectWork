...
from ProjectWork.WebApp.classAuto import *
from sys import path
import json
# isFABIO = True
isFABIO = False
...
@apiBlueprint.route('/admin/getAuto', methods=['GET'])
def admin_getAuto():
...
@apiBlueprint.route('api/auto/<int:id>/aggiorna', methods=['GET', 'POST'])
...
@apiBlueprint.route('api/elimina_auto', methods=['GET', 'POST'])
def elimina_auto():
    c = create_db_connection(DBNAME)
    try:
        data = request.get_json()
...
@apiBlueprint.route('/utenti/<int:id>/modifica', methods=['GET', 'POST'])
...
@apiBlueprint.route('/auto/<int:id>/cancella', methods=['POST'])
...
@apiBlueprint.route('/marchi/<int:id>/cancella', methods=['POST'])
...
@apiBlueprint.route('/motori/<int:id>/cancella', methods=['POST'])
